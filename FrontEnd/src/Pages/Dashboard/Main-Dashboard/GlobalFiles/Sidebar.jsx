      ...
      <div>
        <div style={{ width: isOpen ? "200px" : "70px" }} className={`sidebar`}>
          ...
          <div className="bottomSection">
            ...
            {user?.userType === "nurse" ? (
              <Link className="link" activeclassname="active" to={"/nurseprofile"}>
                <div className="icon">
            ...
            {user?.userType === "nurse" ? (
              <Link className="link" activeclassname="active" to={"/addpatient"}>
                <div className="icon">
            ...
            {user?.userType === "nurse" ? (
              <Link className="link" activeclassname="active" to={"/bookappointment"}>
                <div className="icon">
            ...
            {user?.userType === "admin" ? (
              <Link className="link" activeclassname="active" to={"/addambulance"}>
                <div className="icon">
            ...
            {user?.userType === "doctor" ? (
              <Link className="link" activeclassname="active" to={"/doctorprofile"}>
                <div className="icon">
            ...
            {user?.userType === "doctor" ? (
              <Link className="link" activeclassname="active" to={"/checkappointment"}>
                <div className="icon">
            ...
            {user?.userType === "doctor" ? (
              <Link className="link" activeclassname="active" to={"/createslip"}>
                <div className="icon">
